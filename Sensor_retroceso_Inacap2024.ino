/*
  Sensor de retroceso Arduino con indicador LED
  Taller IoT - Inacap 2024
*/
// Pines utilizados
#define LEDVERDE 2
...
// FunciÃ³n que comprueba si hay que lanzar alguna alerta visual o sonora
